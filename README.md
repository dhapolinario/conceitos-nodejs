...
Implementação de código da aplicação a fim de passar nos testes.
...
- `$ yarn test` para executar os teste.
    `--watch` executa com a opção -o por padrão.
    `--watchAll` executa todos os testes de acordo com a opção escolhida.
